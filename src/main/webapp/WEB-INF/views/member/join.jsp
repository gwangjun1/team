...
$('#emailCheck').click(function(){
	...
	$.ajax({
		async: true,
		type : 'GET',
		data : {mb_email:$('#mb_email').val()}, //mb_id라는 이름으로 mb_id라는 데이터를 @WebServlet("/idsearch.do")에 보낸다
		url : 'emailCheck',
		success : function(data) {
								...
								<div class="login-form">
									...
									<div class="form-group">
										<label for="mb_email">이메일 주소</label> <input type="email"
											...
											placeholder="E-mail">
											<input type="button" value="이메일 인증" id="emailCheck" name="emailCheck">
									...
									<div class="form-group">
										...
										<input type="radio" id="mb_seller" name="mb_seller" value="1"><a class="se">seller</a>&nbsp;&nbsp;&nbsp;&nbsp; 
										<input type="radio" id="mb_seller2" name="mb_seller" value="2"><a class="se">customer</a>
									</div>
									<!-- 주소(우편) -->
									<div class="form-group">
