                                ...
                                <div class="login-form-container">
                                    <div class="login-form">
                                        ...
                                        <form action="" method="post" enctype="multipart/form-data">
											...
											<div>
											<input type="radio" name="pd_category" value="쌀">쌀
											</div>
											<div>
                                            ...
                                            <br>
                                            <br>
                                    	        상품 대표 사진 : <img src="../pd_img_upload/${productVO.pd_img_name_f }" alt="${productVO.pd_name }">${productVO.pd_img_name_f}<br>
											<br>
											상품 상세 사진1 : <img src="../pd_img_upload/${productVO.pd_img_name_s }" alt="${productVO.pd_name }">${productVO.pd_img_name_s}
                                            <hr>
