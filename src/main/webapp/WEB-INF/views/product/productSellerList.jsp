...
<div class="breadcrumb-area pt-205 pb-210 bg-img"
	style="background-image: url(../pd_img_upload/판매자2.jpg)">
	<div class="container">
...
<%-- 										<img src="../pd_img_upload/${productvo.pd_img_name_f }" --%>
<%-- 											alt="${productvo.pd_name }" height="350"> --%>
									</div>
			...
			<c:if test="${pagingMaker.next&&pagingMaker.endPage > 0}">
				<a
					href="productSellerList${pagingMaker.makeURI(pagingMaker.endPage+1)}">
					<button type="button" class="btn btn-theme03">▶</button>
				</a>
			</c:if>
			</div>
