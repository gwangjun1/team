                        ...
                        <tbody>
                        	<c:forEach items="${list}" var="mem">
                        		<c:choose><c:when test="${mem.mb_seller == 1 }">
                        			<tr onclick="location.href='/food_market/admin/sellerList.do?mb_id=${mem.mb_id}'">
								 	<td>${mem.mb_idx }</td>
									<td>${mem.mb_name }</td>
									<td>${mem.mb_id }</td>
									<td>${mem.mb_email }</td>
                        		...
                        		<c:otherwise>
                        			<tr onclick="location.href='/food_market/admin/detailCustomer.do?mb_id=${mem.mb_id}'">
								 	<td>${mem.mb_idx }</td>
									<td>${mem.mb_name }</td>
									<td>${mem.mb_id }</td>
									<td>${mem.mb_email }</td>
                       ...
                       <div style="text-align:center"> 
	                       <c:if test="${pagingMaker.prev}">
							...
							<c:if test="${pagingMaker.next&&pagingMaker.endPage > 0}">
								<a
									href="memberList.do${pagingMaker.makeURI(pagingMaker.endPage+1)}">
									<button type="button" class="btn btn-theme03">▶</button>
								</a>
							</c:if> 
						</div>
