...
<!--                             <form action="../orders/odcomlist" method ="post"> -->
...
<!--                                                     <a href="#"><img src="assets/img/cart/1.jpg" alt=""></a> -->
                                                ...
                                                <a href="#">
                                                <input type="hidden" name="od_pdname" value="${row.pd_name}">
                                                ${row.pd_name}
                                                ...
                                                <span class="amount">
                                                <input type="hidden" name="od_amount" value="${row.amount}">
                                                ${row.amount}
                                                </span>
                                                </td>
                                                <td class="product-quantity">
                                                <input type="hidden" name="od_pdprice" value="${row.price}">
                                                ${row.price }
<%--                                                     <input type="number"  name="amount" min="1" value="${row.amount }"> --%>
                    								<input type="hidden" name="pd_idx" class="pd_idx" value="${row.pd_idx }" 
                                            ...
                                            <tr>
                                                    <td  style="font-size: 30px;"   class="product-quantity" colspan="5">주문금액: ${map.preSumMoney } 배송비 : ${map.delivery } 총금액 : ${map.allsum} 
...
<!--                                     <input type="checkbox1" name="allCheck" id="allCheck" /><label for="allCheck">모두 선택</label>  -->
                                    ...
                                    <table>
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td class="product-name">
                                                <input type="text" name ="od_name" id = "od_name" class = "checknew" value ="${mem.mb_id }" required="required" />
                                                </td>
                                                </tr>
                                                <tr>
                                                <td class="product-price">
                                                ...
                                                <td class="product-quantity">
           										...
           										placeholder="배송 전 연락바랍니다"></textarea>
                                                </td>
                            						</tr>
                                        </tbody>
                                    </table>
                                ...
                                <div class="table-content table-responsive">
                                    ...
                                    <table>
                                     ...
                                     <input type="button" value="결제	" class="order_btn">
                                </div>
